...
# zara
def getComposition():
    closeChat = "document.getElementById('chat-container').remove();"
    scraper.browser.execute_script(closeChat)
    js = "document.getElementsByClassName('_product-composition')[0].scrollIntoView();"
    scraper.browser.execute_script(js)
